...
class Command(BaseCommand):
    def handle(self, *args: Any, **options: Any):
        self.stdout.write("Downloading vendoe static files")
        completed_urls = []
        ...
        if set(completed_urls) == set(VENDOR_STATICFILES.values()):
            self.stdout.write(self.style.SUCCESS("Successfully updated all the vvendor static files."))
        else:
            self.stdout.write(self.style.WARNING("Some fies were not updated."))
